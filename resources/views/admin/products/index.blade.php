...
@if ($product->image_url)
    <img src="{{ asset('storage/' . ltrim($product->image_url, '/')) }}" alt="Product Image" style="width: 80px; height: auto;">
@endif
            ...
            <td>
                <a href="{{ route('admin.products.show', $product) }}" class="btn btn-info btn-sm">Xem</a>
